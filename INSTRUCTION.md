...
You are a senior Android + frontend engineer. Build a production-ready local-first Android vocabulary app, similar UX/logic to my current "48 Laws Vocab" app, but for **French 5000 frequent words**.
